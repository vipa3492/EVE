...
public class DeviceSelection2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ((TextView) findViewById(R.id.title_paired_devices))
                .setText("Please choose the Bluetooth device representative of the light bulb");
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener()
    {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3)
        {
            ...
            ((MyApplication) getApplication()).setDEVICE_ADDRESS_2(address);

            Intent i = new Intent(DeviceSelection2.this, DeviceSelection3.class);
            startActivity(i);
        }
    };
}
