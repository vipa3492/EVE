...
public class DeviceSelection3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ((TextView) findViewById(R.id.title_paired_devices))
                .setText("Please choose the Bluetooth device connected to the IR module");
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener()
    {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3)
        {
            ...
            ((MyApplication) getApplication()).setDEVICE_ADDRESS_3(address);

            Intent i = new Intent(DeviceSelection3.this, MainActivity.class);
            startActivity(i);
        }
    };
}
